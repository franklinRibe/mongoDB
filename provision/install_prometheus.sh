...
cat /vagrant/files/prometheus/prometheus.yml | sudo tee /etc/prometheus/prometheus.yml
cat /vagrant/files/prometheus/prometheus.service | sudo tee /etc/systemd/system/prometheus.service
